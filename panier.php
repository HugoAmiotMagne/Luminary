...
<body>
    <!-- Navbar -->
    <nav class="navbar">
      <img src="./image/fond arriere plan.webp" alt="Luminary eSport Logo" class="logo">
      <ul class="nav-links">
        <li><a href="html accueil.php">Accueil</a></li>
        <li><a href="effectif.phpl">Effectif</a></li>
        <li><a href="boutique.php">Boutique</a></li>
        <li><a href="reseaux.php">Réseaux</a></li>
        <li><a href="contact.php">Recrutement</a></li>
        <li><a href="panier.php"><i class="fa-solid fa-cart-plus" style="color: #ffffff;"></a></i>
      </ul>
    </nav>
